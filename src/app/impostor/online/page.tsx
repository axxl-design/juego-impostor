...
export default function OnlinePage() {
  ...
  const crear = async () => {
    ...
    try {
      const r = await fetch("/api/impostor/sala/crear", {
        method: "POST",
      ...
      router.push(`/impostor/sala/${j.codigo}`);
    } catch (e) {
  ...
  const entrar = async () => {
    ...
    guardarNombre(nombre);
    try {
      const r = await fetch(`/api/impostor/sala/${cod}/accion`, {
        method: "POST",
        headers: { "content-type": "application/json" },
